...
{
    [ImprovmxResourceType("improvmx:index:Alias")]
    public partial class Alias : global::Pulumi.CustomResource
    {
        [Output("alias_id")]
        public Output<int> Alias_id { get; private set; } = null!;
        ...
        public Alias(string name, AliasArgs args, CustomResourceOptions? options = null)
            : base("improvmx:index:Alias", name, args ?? new AliasArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Alias(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("improvmx:index:Alias", name, null, MakeResourceOptions(options, id))
        {
        }
