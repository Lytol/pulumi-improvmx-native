...
export class Alias extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'improvmx:index:Alias';
    ...
    public /*out*/ readonly alias_id!: pulumi.Output<number>;
    ...
    constructor(name: string, args: AliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.forward === undefined) && !opts.urn) {
            ...
            resourceInputs["alias_id"] = undefined /*out*/;
        } else {
            resourceInputs["alias_id"] = undefined /*out*/;
